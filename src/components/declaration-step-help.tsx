  ...
  ja: {
    ...
    review: {
      ...
      items: [
        ...
        { label: "ファイル出力", description: "PDFまたはExcelを1回出力するごとに出力回数を1回消費します。", example: "残り3回 → 出力後2回" },
      ],
    },
  },
  zh: {
    ...
    review: {
      ...
      items: [
        ...
        { label: "文件导出", description: "每导出一次PDF或Excel都会消耗1次导出额度。", example: "剩余3次 → 导出后2次" },
      ],
    },
  },
  en: {
    ...
    review: {
      ...
      items: [
        ...
        { label: "File export", description: "Each PDF or Excel export consumes one export credit.", example: "3 remaining → 2 after export" },
      ],
    },
  },
};
